...
public class TicketAutor extends Ticket {
    ...
    public void onButtonInteraction(ButtonInteractionEvent event) {
        ...
        if (comecarAlgumaAvaliacao) {
            ...
            String idAvaliador = (tipoAvaliacao.equals("designer") || tipoAvaliacao.equals("avaliador"))
            ...
            // --+ Pega o ID do servidor da staff e envia informações dos novos tickets em
            // um canal específico+--//
            VulcanServidorStaff vulcanServidorStaff = new VulcanServidorStaff();
            notificarNovoTicketAberto("Autor", usuario.getUser().getName(), idDoTicketPrivado,
                    VulcanServidorStaff.CARGO_AVALIADOR_ID);
        }
        ...
        switch (tipoAvaliacao) {
            case "autor" -> {
                return "> **Avaliando:** " + usuario.getUser().getName() + "\n" +
                        ...
                        "\n\n" +
                        "Eiiii, " + usuario.getAsMention()
                        + ", tô felizona que tenha optado por fazer uma avaliação na Vulcan Novels para **Autor**.\n" +
            ...
            case "tradutor" -> {
                return "> **Avaliando:** " + usuario.getUser().getName() + "\n" +
                        ...
                        "> **Tipo de Avaliador:** " + servidor.getRoleById(idAvaliador).getAsMention() + "\n\n" +
                        "Olá, " + usuario.getAsMention()
                        + ", fico contente que tenha optado por fazer uma avaliação na Vulcan Novels para **Tradutor**.\n"
                        +
                        "Em breve um " + servidor.getRoleById(idAvaliador).getAsMention()
                        + " iniciará o seu processo de avaliação!";
            }
            ...
            case "designer" -> {
                return "> **Avaliando:** " + usuario.getUser().getName() + "\n" +
                        ...
                        "> **Tipo de Avaliador:** " + servidor.getRoleById(idAvaliador).getAsMention() + "\n\n" +
                        "Olá, " + usuario.getAsMention()
                        + ", fico contente que tenha optado por fazer uma avaliação na Vulcan Novels para **Designer**.\n"
                        +
            ...
            case "avaliador" -> {
                return "> **Avaliando:** " + usuario.getUser().getName() + "\n" +
                        ...
                        "\n\n" +
                        "Olá, " + usuario.getAsMention()
                        + ", fico contente que tenha optado por fazer uma avaliação na Vulcan Novels para **Avaliador**.\n"
                        +
                        "Em breve um " + servidor.getRoleById(idAvaliador).getAsMention()
                        + " iniciará o seu processo de avaliação!";
            }
